<div class="container" id="main-content">
    <div class="row">
        ...
        <div class="span8"><div class="price" style="color: darkblue">¡Personaliza a tu gusto!</div></div>
        <div class="span4">
        ...
        <div class="coldes span2" style="background-color: white">
            ...
            <div>
                <div class="img-icon-designer" option="T-SHIRT">
                    <?php echo HTML::image('media/images/designer/blackTshirt.png', array('width' => '50')) ?> 
                </div>
                <div class="text-icon-designer">
                    Cuello Redondo
                </div>
        ...
        <div class="coldes span8 center-col" >
            <div class="logo-center-col">
                ...
                <div class="overlay-center">
                    <?php echo HTML::image('media/images/logo.jpg', array('class' => 'main-logo','height'=>'60', 'width' => '120', 'unique' => '0')) ?>
                </div>
